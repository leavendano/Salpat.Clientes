...
To update the database use this command from the Web project folder (replace `Salpat.Clientes` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Salpat.Clientes.Infrastructure/Salpat.Clientes.Infrastructure.csproj -s Salpat.Clientes.Web.csproj
```
